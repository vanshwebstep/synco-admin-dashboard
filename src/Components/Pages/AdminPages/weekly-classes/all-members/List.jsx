...
const TrialLists = () => {
  ...
  const ageGroupOptions = [
    ...
    const exportToExcel = () => {
        ...
        // extract numeric ids from "684-0"
        const selectedIds = selectedStudents.map(s => Number(s.split("-")[0]));
    ...
    }, [selectedVenue, franchiseId, fetchBookMemberships, fetchBookMembershipsLoading]);
    ...
    const handleAgentSubmit = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.message || "Failed to assign booking");
            }

    ...
    <>
      ...
      >
        <button
          ...
          className="bg-[#237FEA] md:absolute right-5 top-2 flex items-center gap-2 cursor-pointer text-white px-4 py-2 rounded-xl hover:bg-blue-700 text-sm md:text-base font-semibold"
        >

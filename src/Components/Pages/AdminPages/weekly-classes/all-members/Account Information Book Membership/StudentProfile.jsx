                            ...
                            <div className="bg-white rounded-3xl p-6  space-y-4 mt-4">
                                ...
                                {status == 'waiting list' && canCancelTrial && (
                                    <button
                                        ...
                                        className="w-full bg-red-50 border border-[#B42318] text-[#B42318] text-[18px] rounded-xl py-3 hover:shadow-md transition-all duration-300 font-medium"
                                    >
                                        Remove Waiting List
                                    </button>
                                )}
                                {(status == 'active' || status == 'frozen' || status === "request_to_cancel") && canCancelTrial && (
                                    <button
                                        ...
                                        className={`w-full border text-[18px] rounded-xl py-3 font-medium transition-all duration-300
                                            ${showCancelTrial

...
import General from "../../../accountInfo/General";
import Attendance from "../../../accountInfo/Attendance";
import PaymentHistory from "../../../accountInfo/PaymentHistory";
    ...
    <div className="mt-8 relative">
      <div className="flex items-center w-[max-content] bg-white p-3 gap-1 rounded-2xl p-1 space-x-2">
        <h2 className="cursor-pointer"
          onClick={() => {
            navigate(`/holiday-camp/waiting-list/account-information?id=${data?.id}`, {
...
export default SeeDetailsWaitingList;

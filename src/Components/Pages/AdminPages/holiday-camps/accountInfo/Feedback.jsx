...
const Feedback = () => {
  ...
  const handleSubmit = async () => {
    ...
    const newErrors = {};
    if (!holidayClassScheduleIds?.length) {
      newErrors.holidayClassScheduleIds = "Class is required";
    }
    if (!feedbackType) {
                ...
                <div>
                  ...
                  {studentClassOptions.length > 0 ? (
                    ...
                    <>
                      ...
                      {errors.holidayClassScheduleIds && (
                        <p className="text-red-500 text-xs mt-1">{errors.holidayClassScheduleIds}</p>
                      )}
                    </>
                  )}
                </div>

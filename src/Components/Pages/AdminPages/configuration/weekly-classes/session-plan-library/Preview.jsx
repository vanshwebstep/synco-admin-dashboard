...
const Preview = ({ item, sessionData }) => {
  ...
  useEffect(() => {
    if (selectedGroup && activeTab) {
      ...
      const fieldBannerName = `${tabKey}_banner`;
      ...
      if (selectedGroup[fieldVideoName]) {
       ...
       if (selectedGroup[fieldBannerName]) {
        setBannerUrl(selectedGroup[fieldBannerName]);
      } else {
        setBannerUrl(null); // no match found
      }
            ...
            <div className="flex w-full flex-col border-t border-[#E2E1E5] pt-6 lg:flex-row gap-6">
              ...
              <div className="w-full lg:w-1/2 space-y-2">
                ...
                {bannerUrl && (
                 ...
                 <h2 className="text-[20px] flex items-center gap-2 font-semibold my-3">
